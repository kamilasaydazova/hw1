...
| Понедельник        | Вторник          | Cool  |
| ------------- |:-------------:| -----:|
|  Найти время на завтрак.      | Проснуться чуть позже обычного. | $1600 |
| Постараться на франце.     | Провести день с пользой.    |   $12 |
| Приползти домой. | Снова доползти домой.   |    $1 |
|  Начать писать продолжение. | Тут же сесть за домашку.     |   $12 |
|  Осознать, что нет вдохновения. | Постараться не отвлекаться.    |    $1 |
|  Начать читать фанфики. | |При наличии свободного времени посмотреть аниме| | ашоа|
